...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Independant` (
  ...
  PRIMARY KEY (`numero_entreprise`, `Client_idclient`, `Client_Adresse_idAdresse`),
  INDEX `fk_Independant_Client1_idx` (`Client_idclient` ASC, `Client_Adresse_idAdresse` ASC) VISIBLE,
  CONSTRAINT `fk_Independant_Client1`
    FOREIGN KEY (`Client_idclient` , `Client_Adresse_idAdresse`)
    REFERENCES `fiscale_db`.`Client` (`idclient` , `Adresse_idAdresse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Particulier` (
  ...
  `Client_idclient` INT NOT NULL,
  `Client_Adresse_idAdresse` INT NOT NULL,
  PRIMARY KEY (`registre_national`, `Client_idclient`, `Client_Adresse_idAdresse`),
  INDEX `fk_Particulier_Client1_idx` (`Client_idclient` ASC, `Client_Adresse_idAdresse` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Declaration_fiscale` (
  ...
  PRIMARY KEY (`idDeclaration_fiscale`, `Client_idclient`, `Client_Adresse_idAdresse`, `Type_impot_idType_impot`),
  INDEX `fk_Declaration_fiscale_Client1_idx` (`Client_idclient` ASC, `Client_Adresse_idAdresse` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Membre_cabinet` (
  ...
  PRIMARY KEY (`idMembre`, `Poste_idPoste`),
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Revenu` (
  ...
  PRIMARY KEY (`idRevenu`, `Client_idclient`, `Client_Adresse_idAdresse`, `Type_revenu_code_Type_revenu`),
  INDEX `fk_Revenu_Client1_idx` (`Client_idclient` ASC, `Client_Adresse_idAdresse` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Document_revenu` (
  ...
  `Revenu_Client_idclient` INT NOT NULL,
  `Revenu_Client_Adresse_idAdresse` INT NOT NULL,
  `Revenu_Type_revenu_code_Type_revenu` INT NOT NULL,
  PRIMARY KEY (`idDocument_revenu`, `Revenu_idRevenu`, `Revenu_Client_idclient`, `Revenu_Client_Adresse_idAdresse`, `Revenu_Type_revenu_code_Type_revenu`),
  INDEX `fk_Document_revenu_Revenu1_idx` (`Revenu_idRevenu` ASC, `Revenu_Client_idclient` ASC, `Revenu_Client_Adresse_idAdresse` ASC, `Revenu_Type_revenu_code_Type_revenu` ASC) VISIBLE,
  CONSTRAINT `fk_Document_revenu_Revenu1`
    FOREIGN KEY (`Revenu_idRevenu` , `Revenu_Client_idclient` , `Revenu_Client_Adresse_idAdresse` , `Revenu_Type_revenu_code_Type_revenu`)
    REFERENCES `fiscale_db`.`Revenu` (`idRevenu` , `Client_idclient` , `Client_Adresse_idAdresse` , `Type_revenu_code_Type_revenu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Membre_cabinet_has_Declaration_fiscale` (
  ...
  `Membre_cabinet_Poste_idPoste` INT NOT NULL,
  `Declaration_fiscale_idDeclaration_fiscale` INT NOT NULL,
  `Declaration_fiscale_Client_idclient` INT NOT NULL,
  `Declaration_fiscale_Client_Adresse_idAdresse` INT NOT NULL,
  `Declaration_fiscale_Type_impot_idType_impot` INT NOT NULL,
  PRIMARY KEY (`Membre_cabinet_idMembre`, `Membre_cabinet_Poste_idPoste`, `Declaration_fiscale_idDeclaration_fiscale`, `Declaration_fiscale_Client_idclient`, `Declaration_fiscale_Client_Adresse_idAdresse`, `Declaration_fiscale_Type_impot_idType_impot`),
  INDEX `fk_Membre_cabinet_has_Declaration_fiscale_Declaration_fisca_idx` (`Declaration_fiscale_idDeclaration_fiscale` ASC, `Declaration_fiscale_Client_idclient` ASC, `Declaration_fiscale_Client_Adresse_idAdresse` ASC, `Declaration_fiscale_Type_impot_idType_impot` ASC) VISIBLE,
  INDEX `fk_Membre_cabinet_has_Declaration_fiscale_Membre_cabinet1_idx` (`Membre_cabinet_idMembre` ASC, `Membre_cabinet_Poste_idPoste` ASC) VISIBLE,
  CONSTRAINT `fk_Membre_cabinet_has_Declaration_fiscale_Membre_cabinet1`
    FOREIGN KEY (`Membre_cabinet_idMembre` , `Membre_cabinet_Poste_idPoste`)
    REFERENCES `fiscale_db`.`Membre_cabinet` (`idMembre` , `Poste_idPoste`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Membre_cabinet_has_Declaration_fiscale_Declaration_fiscale1`
    FOREIGN KEY (`Declaration_fiscale_idDeclaration_fiscale` , `Declaration_fiscale_Client_idclient` , `Declaration_fiscale_Client_Adresse_idAdresse` , `Declaration_fiscale_Type_impot_idType_impot`)
    REFERENCES `fiscale_db`.`Declaration_fiscale` (`idDeclaration_fiscale` , `Client_idclient` , `Client_Adresse_idAdresse` , `Type_impot_idType_impot`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Depense` (
  ...
  PRIMARY KEY (`idDepense`, `Client_idclient`, `Client_Adresse_idAdresse`, `Type_depense_codeType`),
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Document_depense` (
  ...
  `Depense_Client_idclient` INT NOT NULL,
  `Depense_Client_Adresse_idAdresse` INT NOT NULL,
  `Depense_Type_depense_codeType` INT NOT NULL,
  PRIMARY KEY (`idDocument_depense`, `Depense_idDepense`, `Depense_Client_idclient`, `Depense_Client_Adresse_idAdresse`, `Depense_Type_depense_codeType`),
  INDEX `fk_Document_depense_Depense1_idx` (`Depense_idDepense` ASC, `Depense_Client_idclient` ASC, `Depense_Client_Adresse_idAdresse` ASC, `Depense_Type_depense_codeType` ASC) VISIBLE,
  CONSTRAINT `fk_Document_depense_Depense1`
    FOREIGN KEY (`Depense_idDepense` , `Depense_Client_idclient` , `Depense_Client_Adresse_idAdresse` , `Depense_Type_depense_codeType`)
    REFERENCES `fiscale_db`.`Depense` (`idDepense` , `Client_idclient` , `Client_Adresse_idAdresse` , `Type_depense_codeType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `fiscale_db`.`Personne_a_charge` (
  ...
  `Client_idclient` INT NOT NULL,
  `Client_Adresse_idAdresse` INT NOT NULL,
  PRIMARY KEY (`Registre_national_personne_a_charge`, `Client_idclient`, `Client_Adresse_idAdresse`),
  INDEX `fk_Personne_a_charge_Client1_idx` (`Client_idclient` ASC, `Client_Adresse_idAdresse` ASC) VISIBLE,
